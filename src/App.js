  ...
  */
  ...
  return (
    <>
      ...
      <Example1 /> {/* Is it true: The entire app re-renders whenever a state variable changes. Hint: NOPE! */}
      <Example2 /> {/* Is it true: A component will re-render because its props change. Hint: It is tricky, isn't it?*/}
    </>
  );
}
